...
export default function ContentPolicy() {
  ...
  const APPEALS_EMAIL = "appeals@ourspace.app";
  ...
  const tiers = [
    ...
    },
    {
      ...
      items: [
        ...
        "Excessive nudity or sexually suggestive content outside designated areas",
    ...
    <div style={{ minHeight: "100vh", background: "#0d0d1a", color: "#f0f0f0", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 16px 60px" }}>
        ...
        <div style={{ background: "#1a0f00", borderRadius: 16, border: "1px solid #ef444430", padding: "20px 24px", marginBottom: 24 }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.8, margin: 0 }}>
            Any content that sexually exploits minors is immediately removed, and the account is permanently banned without possibility of appeal. All CSAM is reported to the National Center for Missing & Exploited Children (NCMEC) CyberTipline at CyberTipline.org and to applicable law enforcement. OurSpace 2.0 uses hash-matching and user reporting to detect CSAM proactively. If you encounter this content, report it immediately to {SAFETY_EMAIL}.
          </p>
        </div>
        ...
        <div style={{ background: "#13132b", borderRadius: 16, border: "1px solid #2a2a45", padding: "20px 24px", marginBottom: 24 }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.8, margin: "0 0 12px" }}>
            <strong style={{ color: "#f0f0f0" }}>To report content:</strong> Use the 🚩 Report button on any post, profile, or message, or email {SAFETY_EMAIL}.
          </p>
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.8, margin: "0 0 12px" }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.8, margin: 0 }}>
            <strong style={{ color: "#f0f0f0" }}>To appeal a decision:</strong> Email {APPEALS_EMAIL} with "Appeal" in the subject line, your account email, the content in question, and your reasoning. We respond to all appeals within 7 business days.
          </p>
        </div>
        ...
        <div style={{ background: "#0f2a1e", borderRadius: 16, border: "1px solid #4ade8030", padding: "20px 24px", marginBottom: 32 }}>
          ...
          <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.8, margin: 0 }}>
            The Human-Only Filter allows users to view only content verified as human-created. This filter relies on creator self-disclosure and community reporting. Users who falsely label AI content to bypass this filter are subject to enforcement action. Our moderation team audits flagged content and may reclassify it based on evidence.
          </p>
        </div>

        <div style={{ padding: "20px 24px", background: "#13132b", borderRadius: 16, border: "1px solid #2a2a45", textAlign: "center" }}>
          <p style={{ color: "#64748b", fontSize: 13, margin: "0 0 8px" }}>Safety reports & policy questions</p>
          <a href={`mailto:${SAFETY_EMAIL}`} style={{ color: "#c084fc", fontWeight: 700, fontSize: 15, textDecoration: "none" }}>{SAFETY_EMAIL}</a>
          <p style={{ color: "#475569", fontSize: 12, marginTop: 16, marginBottom: 0 }}>
            © {new Date().getFullYear()} OurSpace 2.0. All rights reserved.{" "}
