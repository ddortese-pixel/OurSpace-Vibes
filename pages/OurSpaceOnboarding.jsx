    ...
    <div style={S}>
      ...
      {step>0&&step<4&&(
        <div style={{ display:"flex",gap:8,justifyContent:"center",marginBottom:32 }}>
          {[1,2,3].map(i=>(
            <div key={i} style={{ width:i<=step?24:8,height:8,borderRadius:999,background:i<=step?"#c084fc":"#2a2a45",transition:"all 0.3s" }} />
          ))}
        </div>
      )}
          ...
          {!needsParent ? (
            <div>
              ...
              <div style={{ textAlign:"center",marginTop:14,fontSize:12,color:"#64748b" }}>
                ...
                <span style={{ color:"#c084fc",cursor:"pointer" }} onClick={()=>navigate("/TermsOfService")}>Terms</span>{" "}and{" "}
            ...
            <div>
              ...
              <label style={{ display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer",color:"#94a3b8",fontSize:13 }}>
                ...
                I am the parent/guardian and agree to the{" "}
                <span style={{ color:"#c084fc" }}>Terms of Service</span> and{" "}
                <span style={{ color:"#22d3ee" }}>Privacy Policy</span> on behalf of my child.
              </label>
              {ageError&&<div style={{ marginTop:10,padding:12,background:"#2a1515",borderRadius:8,color:"#f87171",fontSize:13 }}>{ageError}</div>}
